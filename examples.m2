...
tkachev14 = hashTable {
    {1,1} => set {1}, {1, -1} => set {-1}, {1, -1/2} => set {-1/2}, {1, 1/2} => set {1/2},
    {-1, 1} => set {-1}, {-1, -1} => set {1}, {-1, -1/2} => set {1/2}, {-1, 1/2} => set {-1/2, 1/2},
    {-1/2, 1} => set {-1/2}, {-1/2, -1} => set {1, -1/2}, {-1/2, 1/2} => set {-1, 1/2},
    {1/2, 1} => set {1/2}, {1/2, -1} => set {1/2, -1/2}, {1/2, -1/2} => set {-1, 1/2}, {1/2, 1/2} => {1, -1, -1/2}
}
